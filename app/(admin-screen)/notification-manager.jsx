        ...
        <SafeAreaView style={{ flex: 1, marginTop: 20 }}>
          <View className="flex-row items-center justify-between px-4 mb-2">
            <View className="flex-row items-center">
              ...
              <Text className="font-pmedium text-lg">Select Users</Text>
            </View>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        {users.map((user) => (
          <Chip
            ...
            avatar={
              user.profile_image ? (
                <Avatar.Image size={24} source={{ uri: user.profile_image }} />
              ) : (
                <Avatar.Text
                  size={24}
  ...
  const uploadImageToCloud = async (imageUri) => {
    ...
    try {
      ...
      if (!data || !data.imageUrl) {
        ...
        throw new Error(
          "No image URL received from server. Response format: " +
            JSON.stringify(data)
        );
      }
              ...
              {notificationType === "multiple" && (
                <View className="mt-2">
                  ...
                  >
                    ...
                    <IconButton icon="chevron-right" size={24} color="#666" />
                  </TouchableOpacity>
                  ...
                  anchor={
                    ...
                    >
                      <View className="flex-row items-center">
                        ...
                        <Text
                          className={
                            imageUri ? "font-pmedium" : "text-gray-500"
                          }
                        >
                  ...
                  <Menu
                    ...
                    anchor={
                      ...
                      >
                        ...
                        />
                        <Text className="ml-2">
                          {ICON_OPTIONS.find((opt) => opt.name === icon)
                            ?.label || "Bell"}
                        </Text>
                      </TouchableOpacity>
                    }
                ...
                <View className="flex-row flex-wrap">
                  {TYPE_OPTIONS.map((option) => (
                    <Chip
                      ...
                      textStyle={{
                        color: type === option.value ? "white" : "black",
                      }}
                      style={{
                        margin: 4,
                        backgroundColor:
                          type === option.value ? PRIMARY_COLOR : "#D3D3D3",
                        borderRadius: 20,
                      }}
                      selectedColor="white"
                    >
